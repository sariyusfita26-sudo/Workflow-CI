...
Versi ini mendukung argparse agar bisa dipanggil
dari MLProject entry point.
...
def save_roc_curve(y_test, y_pred_prob, path="roc_curve.png"):
    ...
    ax.set_title("ROC-AUC Curve - Random Forest", fontsize=13,
                 fontweight="bold")
...
def run(train_path, test_path, n_estimators, max_depth, random_state):
    ...
    with mlflow.start_run(run_name="RandomForest_MLProject"):
